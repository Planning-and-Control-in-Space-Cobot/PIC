...
\begin{table}[!ht]
    ...
    \resizebox{0.8\textwidth}{!}{%
        ...
        \hline
            \textbf{} & \textbf{Jan} & \textbf{Feb} & \textbf{Mar} & \textbf{Apr} & \textbf{May} & \textbf{Jun} & \textbf{Jul } & \textbf{Aug} & \textbf{Oct} \\ \hline
            ...
            \textbf{Consensus between system} & ~ & \cellcolor{lightgreen} & \cellcolor{darkgreen} & \cellcolor{darkgreen} & \cellcolor{lightgreen} & ~ & ~ & ~ & ~ \\ 
            \textbf{Simulation Study} & ~ & ~ & \cellcolor{lightgreen} & \cellcolor{darkgreen} & \cellcolor{darkgreen} & \cellcolor{lightgreen}~ & ~ & ~ & ~ \\ 
            \textbf{Real world data} & ~ & ~ & ~ &  \cellcolor{lightgreen} & \cellcolor{darkgreen} &\cellcolor{darkgreen} & \cellcolor{lightgreen} & \cellcolor{lightgreen} & ~ \\ 
            ...
            \textbf{Dissertation writting} & \cellcolor{lightgreen} & \cellcolor{lightgreen} & \cellcolor{lightgreen} & \cellcolor{lightgreen} & \cellcolor{lightgreen} & \cellcolor{darkgreen} & \cellcolor{darkgreen} & \cellcolor{darkgreen} & \cellcolor{darkgreen} \\ \hline
        \end{tabular}
    }
